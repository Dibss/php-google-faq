...
<body>
  ...
  <header>
    <div class="d-flex jc-between ai-center">
      <div class="ml-3">
        <img class="img-respo va-middle" src="./assets/img/logo.png" alt="google logo">
        <span class="text-gray">Privacy e termini</span>
      </div>
      <div class="mr-3 d-flex ai-center">
    ...
    <nav class="ml-3">
      <ul class="d-flex">
        <li><a class="text-gray fw-bold" href="#">Introduzione</a></li>
        <li><a class="text-gray fw-bold" href="#">Norme sulla privacy</a></li>
        <li><a class="text-gray fw-bold" href="#">Termini di servizio</a></li>
        <li><a class="text-gray fw-bold" href="#">Tecnologie</a></li>
        <li class="border-b-blue"><a class="text-blue fw-bold" href="#">Domande frequenti</a></li>
      </ul>
    </nav>
    <hr>
  </header>
  ...
  <main class="container">
    <div>
      <?php 
        foreach($faqs as $faq){
      ?>
        <h2 class="text-darkgray mb-2"><?php echo $faq['question']; ?></h2>
        <span class="text-darkgray mb-8 d-block"><?php echo $faq['answer']; ?></span>
      <?php
        }
      ?>
    </div>
